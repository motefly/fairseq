...
class MixelectraHubInterface(nn.Module):
    """A simple PyTorch Hub interface to RoBERTa.

    Usage: https://github.com/pytorch/fairseq/tree/master/examples/mixelectra
    """
    ...
    def encode(self, sentence: str, *addl_sentences, no_separator=False) -> torch.LongTensor:
        ...
        requires leading spaces. For example::
            ...
            >>> mixelectra.encode('Hello world').tolist()
            [0, 31414, 232, 2]
            >>> mixelectra.encode(' world').tolist()
            [0, 232, 2]
            >>> mixelectra.encode('world').tolist()
            [0, 8331, 2]
        """
    ...
    def extract_features_aligned_to_words(self, sentence: str, return_all_hiddens: bool = False) -> torch.Tensor:
        ...
        from fairseq.models.mixelectra import alignment_utils
    ...
    def disambiguate_pronoun(self, sentence: str) -> bool:
        ...
        assert hasattr(self.task, 'disambiguate_pronoun'), \
            'mixelectra.disambiguate_pronoun() requires a model trained with the WSC task.'
        with utils.eval(self.model):
