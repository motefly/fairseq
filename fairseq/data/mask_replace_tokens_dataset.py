...
class MaskReplaceTokensDataset(BaseWrapperDataset):
    """
    ...
    @classmethod
    def apply_mask_replace(cls, dataset: torch.utils.data.Dataset, *args, **kwargs):
    ...
    def __init__(
        ...
        if random_replace_prob > 0.0 and self.random_replace:
