...
do
  ...
  do
	...
	BPE_CODE_PATH="/gpu-01-data/zhenhui/Projects/BERT-dev/StackingBERT/examples/bert/bpe-code"
	COMMON_PATH="/home/zhenhui/Projects/my-fairseq/electra/common"
  ...
  do
    ...
    fairseq-preprocess \
      ...
      --workers 60 \
      --srcdict /gpu-01-data/zhenhui/Projects/BERT-dev/fairseq/data-bin/wiki_book_32768/dict.txt;
  done
  if [[ "$TASK" !=  "STS-B" ]]
  then
    fairseq-preprocess \
